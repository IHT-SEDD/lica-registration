...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('pre-analytics')->group(function () {
        ...
        Route::put('reset-analyzer/{transactionId}', 'PreAnalyticController@resetAnalyzer');
    });
    // END Pre Analytics
    ...
    Route::prefix('analytics')->group(function () {
        ...
        Route::get('check-validated-test/{transactionId}/{groupId?}', 'AnalyticController@checkValidatedTest');
        Route::get('check-validated-test-group/{transactionId}/{groupId?}', 'AnalyticController@checkValidatedTestGroup');
    ...
    Route::prefix('report')->group(function () {
        ...
        Route::get('/patient-datatable/{startDate?}/{endDate?}/{typeId?}', 'ReportController@patientDatatable');
        ...
        // INSURANCE RIKES REPORT 
        Route::get('/insurance-rikes', 'ReportController@insuranceRikesReport');
        Route::get('/insurance-rikes-datatable/{startDate?}/{endDate?}', 'ReportController@insuranceRikesDatatable');
        Route::get('/insurance-rikes-print/{startDate?}/{endDate?}', 'ReportController@insuranceRikesPrint');

        // INSURANCE RIKES REPORT 
        Route::get('/insurance-nikah', 'ReportController@insuranceNikahReport');
        Route::get('/insurance-nikah-datatable/{startDate?}/{endDate?}', 'ReportController@insuranceNikahDatatable');
        Route::get('/insurance-nikah-print/{startDate?}/{endDate?}', 'ReportController@insuranceNikahPrint');
    ...
    Route::prefix('quality-control')->group(function () {
        ...
        Route::get('/edit-reference-1/{id}', 'QcController@editReferenceData1');
        Route::get('/get-reference-2/{id}', 'QcController@getReferenceData2');
        Route::get('/edit-reference-2/{id}', 'QcController@editReferenceData2');
        Route::get('/get-reference-3/{id}', 'QcController@getReferenceData3');
        Route::get('/edit-reference-3/{id}', 'QcController@editReferenceData3');
        ...
        Route::get('/datatable-qc-data-level-2/{id}/{startDate?}/{endDate?}', 'QcController@datatableQcDataLevel2');
        ...
        Route::put('/update-reference-1/{id}', 'QcController@updateReferenceData1');
        Route::put('/update-reference-2/{id}', 'QcController@updateReferenceData2');
