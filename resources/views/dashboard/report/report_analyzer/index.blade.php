                                ...
                                <table class="table gy-1 align-middle table-striped px-0 datatable-ajax" id="datatables">
                                    <thead>
                                        <tr class="text-start text-gray-600 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="text-start" width="5%">Analyzer ID</th>
                                            <th class="text-start" width="30%">Analyer Name</th>
                                            <th class="text-start" width="5%">Test ID</th>
                                            <th class="text-start" width="30%">Test Name</th>
                                            <th class="text-start" width="5%">Total Test</th>
                                        </tr>
                                    </thead>
