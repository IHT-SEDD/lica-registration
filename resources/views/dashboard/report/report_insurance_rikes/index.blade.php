                        ...
                        <div class="p-0">
                            ...
                            <div class="d-flex justify-content-between">
                                <h1 class="anchor fw-bolder mb-5">
                                    Insurance RIKES Berkala Report
                                </h1>
                            </div>
                            <!--end::Heading-->
                            <!--begin::CRUD-->
                            <div class="py-5">
                                ...
                                <div class="d-flex justify-content-between mb-5">
                                    <div class="col-lg-3">
                                        <button type="button" id="print-report" href="{{url('report/insurance-rikes-print')}}" class="btn btn-sm btn-light btnPrint">Print Report</button>
                                        <button type="button" id="export-report" class="btn btn-sm btn-light" onclick="tablesToExcel(['datatables'], ['Insurance Report'], 'Insurance-RIKES-Nikah-Report.xls', 'Excel')">Export Excel</button>
                                    </div>
                                    <div class="col-lg-3">
                                    </div>
                                    <div class="col-lg-3">
...
<script src="{{asset('js/report/report_insurance_rikes/index.js')}}"></script>
<script src="{{asset('js/report/report_insurance_rikes/datatable.js')}}"></script>
