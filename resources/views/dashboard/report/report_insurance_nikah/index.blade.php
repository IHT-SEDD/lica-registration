                        ...
                        <div class="p-0">
                            ...
                            <div class="py-5">
                                ...
                                <div class="d-flex justify-content-between mb-5">
                                    <div class="col-lg-3">
                                        <button type="button" id="print-report" href="{{url('report/insurance-nikah-print')}}" class="btn btn-sm btn-light btnPrint">Print Report</button>
...
<script src="{{asset('js/report/report_insurance_nikah/index.js')}}"></script>
<script src="{{asset('js/report/report_insurance_nikah/datatable.js')}}"></script>
