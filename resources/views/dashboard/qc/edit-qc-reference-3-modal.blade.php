...
<div id="edit-qc-reference-3-modal" class="modal fade" tabindex="-1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="edit-patient-details-form">
                    <input type="hidden" id="qc_reference_id_edit_3" name="qc_reference_id_edit_3"  data-qc-reference-id-edit-level-3="" class="form-control form-control-solid form-control-sm">
                    <input type="hidden" id="qc_reference_id_3" data-qc-reference-id-level-3="" name="qc_reference_id_3" class="form-control form-control-solid form-control-sm">
                    ...
                    <div class="fv-row row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <select class="form-select form-select-sm form-select-solid select-two" data-control="select2" id="edit_standard_deviation3" name="standard_deviation1" data-placeholder="Select Standard Deviation">
                    ...
                    <div class="fv-row row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="text" id="edit_control_name3" name="control_name3" class="form-control form-control-solid form-control-sm" >
                        </div>
                    </div>
                    <div class="fv-row row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="text" id="edit_low_value3" name="low_value3" class="form-control form-control-solid form-control-sm" >
                        </div>
                    </div>
                    <div class="fv-row row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="text" id="edit_high_value3" name="high_value3" onfocusout="editonFocusOut3()" class="form-control form-control-solid form-control-sm" >
                        </div>
                    </div>
                    <div class="fv-row row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="text" id="edit_target_value3" name="target_value3" class="form-control form-control-solid form-control-sm" >
                        </div>
                    </div>
                    <div class="fv-row row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="text" id="edit_deviation3" name="deviation3" class="form-control form-control-solid form-control-sm" >
                        </div>
                    </div>
                ...
                <div class="mb-2 mt-8">
                    <button type="button" id="edit_button_update_data" onclick="updateReference3()" class="form-control btn btn-light-success" data-qc-id-1="" data-qc-id-2="" data-qc-id-3=""> Update Reference</button>
