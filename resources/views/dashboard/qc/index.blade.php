                                    ...
                                    <div class="col-md-4">
                                        <div class="fv-row row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <button type="button" id="edit-reference-1" onclick="editReference1()" class="btn btn-sm btn-info "  style="float: right; margin-right: 20px;" >Edit Reference</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="fv-row row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <button type="button" id="edit-reference-2" onclick="editReference2()" class="btn btn-sm btn-info "  style="float: right; margin-right: 20px;" >Edit Reference</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="fv-row row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <button type="button" id="edit-reference-3" onclick="editReference3()" class="btn btn-sm btn-info "  style="float: right; margin-right: 20px;" >Edit Reference</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@include('dashboard.qc.edit-qc-reference-1-modal')
@include('dashboard.qc.edit-qc-reference-2-modal')
@include('dashboard.qc.edit-qc-reference-3-modal')
@endsection
