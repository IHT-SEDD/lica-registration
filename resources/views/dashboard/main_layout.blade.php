											...
											<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown w-100 w-lg-600px p-5 p-lg-5">
												...
												<div class="row" data-kt-menu-dismiss="true">
													...
													<div class="col-lg-4 border-left-lg-1">
														...
														<div class="menu-inline menu-column menu-active-bg">
															<div class="menu-item">
																<a href="{{ url('report/insurance-rikes') }}" class="menu-link">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Insurance RIKES Berkala Report</span>
																</a>
															</div>
														</div>
														<div class="menu-inline menu-column menu-active-bg">
															<div class="menu-item">
																<a href="{{ url('report/insurance-nikah') }}" class="menu-link">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Insurance RIKES Nikah Report</span>
																</a>
															</div>
														</div>
														<div class="menu-inline menu-column menu-active-bg">
