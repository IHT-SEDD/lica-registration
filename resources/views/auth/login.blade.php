		...
		<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed"
			...
			<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
				...
				<div class="d-flex flex-center p-10; w-lg-400px">
					<table width="100%">
						<tr>
							<td style="width:50%;"><img src="{{asset('images/logo-diponegoro.png')}}"
									style="height: 100px; width: 100px; margin-left: 50px;"></td>
							<td style="width:50%;"><img src="{{asset('images/logo-lica.png')}}"
									style="height: 100px; width: 150px; margin-left: 0px"></td>
						</tr>
					</table>
				</div>
				<br>
				<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
					...
					{{-- <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
						...
						<div class="fv-row mb-5">
							...
							<!--end::Wrapper-->
							<!--begin::Input-->
							{{ Form::password('password', ['class' => 'form-control form-control-md
							form-control-solid'])}}
							<!--end::Input-->
						</div>
